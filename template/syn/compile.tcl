...
# For students who implement L1 buffer, 
# please set dont touch for the L1 buffer.
# You may change the name and the number of the L1 buffer.
set_dont_touch {bank0, bank1}
